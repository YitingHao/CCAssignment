...
public class CheckPermutation {
	public static void main(String[] args) {
		...
		String test1_1 = "adghsdfgry";
		String test1_2 = "ryadghsdfg";
		System.out.println(test.checkMutation(test1_1, test1_2));
		String test2_1 = "adghs*dfgry";
		String test2_2 = "ryadghsdfg";
		System.out.println(test.checkMutation(test2_1, test2_2));
	}
	public boolean checkMutation (String s1, String s2)
	{
		...
		if (s1.length() == s2.length()) 
		{
			...
			for (int i = 0; i < s2.length(); i ++)
			{
				...
				if (check.containsKey(s2.charAt(i)))
				{
					...
					// If If show-up times is 0, remove from Hashtable
